        ...
        <div className={`md:flex items-center ${isOpen ? 'block' : 'hidden'} w-full md:w-auto`}>
          <ul className="flex flex-col md:flex-row items-center md:space-x-8 w-full md:w-auto">
            <li className="list-none my-2 md:my-0 mx-5 text-lg">
              <Link href="/" className="hover:text-gray-300 block">Home</Link>
            </li>
            <li className="list-none my-2 md:my-0 mx-5 text-lg">
              <Link href="/about" className="hover:text-gray-300 block">About</Link>
            </li>
            <li className="list-none my-2 md:my-0 mx-5 text-lg">
              <Link href="/services" className="hover:text-gray-300 block">Stream</Link>
            </li>
          </ul>
          <ul className="flex flex-wrap items-center justify-center space-x-4 w-full md:w-auto mt-4 md:mt-0 md:ml-8">
